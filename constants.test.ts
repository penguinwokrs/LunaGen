...
// 【重要】禁止文の中で例示するのも同じ罠。旧プロンプトの「食事・飲みの誘いは禁止
// （食の好みに触れるのはOK）」という"禁止"の1行が、実際に食べ物への逃げを生んでいた。
// このテストが厳しすぎると感じても、緩める前に必ずこの経緯を確認すること。
// 食べ物の混入はこれが原因だったので、具体名詞の再混入をテストで縛る。
const CONCRETE_TOPIC_WORDS = [
  "食事", "ご飯", "ごはん", "飲みに", "グルメ", "料理", "レストラン",
  "カフェ", "ランチ", "ディナー", "お酒", "居酒屋",
  // 禁止文の中で例として挙げるのも同じ罠。2026-08-02、捏造を禁じる行に
  // 「好きな店や食べ物など」と書いてしまい、名指しを1つ増やしかけた。
  "食べ物", "食べ歩き"
]
